...
<head>
    ...
    <style type="text/css">
        ...
        body, #bodyTable{background-color:#FEFEFE;}
        #emailHeader{background-color:#FEFEFE;}
...
<body bgcolor="#FEFEFE" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
